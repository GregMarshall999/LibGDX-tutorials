...
public class FLGTDebugRenderer {
    ...
    public FLGTDebugRenderer () {
        this(true, true, false, true, false, true);
    }

    public FLGTDebugRenderer (boolean drawBodies, boolean drawJoints, boolean drawAABBs, boolean drawInactiveBodies,
    ...
    private Color getColorByBody (Body body) {
        ...
        else if (body.getType() == StaticBody)
            return SHAPE_STATIC;
        else if (body.getType() == KinematicBody)
